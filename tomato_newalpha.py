...
class Trader:
    def __init__(self):
        ...
        # Hyperparameters
        self.tomatoes_alpha = 0.20
        self.tomatoes_vol_alpha = 0.10
        self.tomatoes_base_spread = 1.5
        self.tomatoes_take_size = 15
        self.tomatoes_quote_size = 20
    ...
    def search_buys(
        ...
        """
        Take asks priced below acceptable_price.
        """
        order_depth = state.order_depths[product]
    ...
    def search_sells(
        ...
        """
        Take bids priced above acceptable_price.
        """
        order_depth = state.order_depths[product]
    ...
    def trade_tomatoes(self, state: TradingState):
        ...
        # Volatility estimate from absolute mid-price changes
        ...
        # Adaptive spread
        spread = self.tomatoes_base_spread + self.tomatoes_volatility
        ...
        logger.print(
            f"{product} mid={mid:.2f} fair={fair_value:.2f} vol={self.tomatoes_volatility:.2f} pos={position}"
        )
