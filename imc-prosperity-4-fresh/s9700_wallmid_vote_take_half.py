...
class Trader:
    def __init__(self):
        ...
        self.conversions = 0
        self.traderData = "S9700_WALLMID_VOTE_TAKE_HALF"
        ...
        self.osmium_micro_sign_weight = 0.0
        self.osmium_void_sign_weight = 0.0
        self.osmium_wallmid_vote_weight = 1.0
    ...
    def trade_osmium(self, state: TradingState):
        ...
        void_skew = features.get("void_skew", 0.0)
        ...
        take_fair_value = self.osmium_fair_value + 0.50 * alpha_adjustment
