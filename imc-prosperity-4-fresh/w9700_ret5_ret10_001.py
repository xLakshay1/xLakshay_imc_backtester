...
class Trader:
    def __init__(self):
        ...
        self.conversions = 0
        self.traderData = "MAINBH_OSMIUM_RET5_RET10_ALPHA_MM_V1"
        ...
        self.osmium_ret10_weight = 0.04
        self.osmium_ret10_clip = 14.0
    ...
    def get_osmium_alpha_features(self, state: TradingState, product: str):
        ...
        ret_10 = 0.0
        if len(self.osmium_mid_history) >= 10:
            ret_10 = mid - self.osmium_mid_history[-10]
    ...
    def trade_osmium(self, state: TradingState):
        ...
        ret_10_signal = self.clamp(
            features["ret_10"],
            -self.osmium_ret10_clip,
            self.osmium_ret10_clip,
        )
        alpha_adjustment = (
            ...
            - self.osmium_ret10_weight * ret_10_signal
        )
        ...
        logger.print(
            f"OSMIUM_RET5_RET10_ALPHA mid={mid:.2f} ema={self.osmium_fair_value:.2f} "
            f"micro_sig={micro_signal:.2f} depth_sig={depth_signal:.2f} "
            f"imb={top_imbalance:.2f} move={recent_move:.2f} "
            f"ret5={ret_5_signal:.2f} ret10={ret_10_signal:.2f} "
