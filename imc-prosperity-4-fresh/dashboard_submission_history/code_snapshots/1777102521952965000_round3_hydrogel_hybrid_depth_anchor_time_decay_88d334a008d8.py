...
class Trader:
    def __init__(self):
        ...
        self.depth_p25 = 70.0
        self.depth_p75 = 80.0
        self.early_ema_alpha = 0.05
        self.late_ema_alpha = 0.16
        self.early_take_mult = 0.80
        self.late_take_mult = 0.35
        self.early_passive_mult = 0.65
        self.late_passive_mult = 0.28

        self.orders: Dict[Symbol, list[Order]] = {}
        self.buy_reserved: Dict[Symbol, int] = {}
        self.sell_reserved: Dict[Symbol, int] = {}
        self.conversions = 0
        self.traderData = "R3_HYDROGEL_HYBRID_DEPTH_ANCHOR_TIME_DECAY_V1"
    ...
    def trade_hydrogel(self, state: TradingState, memory: Dict[str, Any]) -> None:
        ...
        effective_ema_alpha = (1.0 - progress) * self.early_ema_alpha + progress * self.late_ema_alpha
        ...
        take_mult = (1.0 - progress) * self.early_take_mult + progress * self.late_take_mult
        passive_mult = (1.0 - progress) * self.early_passive_mult + progress * self.late_passive_mult
        ...
        logger.print(
            ...
            f"depth={depth_total:.0f} pos={position} progress={progress:.3f} alpha={effective_ema_alpha:.3f} "
            f"take={take_threshold:.2f} pass={passive_offset:.2f}"
        )
