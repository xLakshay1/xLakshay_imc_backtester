...
class Trader:
    def __init__(self):
        ...
        self.conversions = 0
        self.traderData = "MAINBH_OSMIUM_RET5_PRESSURE_PEPPER_LINE_MM_V1"
        ...
        # as a mean-reversion sleeve around a live-detected linear fair line.
        self.pepper_limit = 80
        self.pepper_core_target = 70
        self.pepper_sleeve_target = 80
        self.pepper_core_clip_size = 70
    ...
    def trade_pepper(self, state: TradingState):
        ...
        # Taker sleeve: buy only the extra 10 units when detrended price is cheap,
