...
class Trader:
    def __init__(self):
        ...
        self.conversions = 0
        self.traderData = "MAINBH_OSMIUM_ALPHA_MM_V1"
    ...
    def trade_osmium(self, state: TradingState):
        ...
        logger.print(
            f"OSMIUM_ALPHA mid={mid:.2f} ema={self.osmium_fair_value:.2f} "
            f"micro_sig={micro_signal:.2f} depth_sig={depth_signal:.2f} "
            f"imb={top_imbalance:.2f} move={recent_move:.2f} alpha={alpha_adjustment:.2f} "
