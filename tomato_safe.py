...
class Trader:
    def __init__(self):
        ...
        self.conversions = 0
        self.traderData = "SAFE_EMA_VOL_V1"
        ...
        self.tomatoes_alpha = 0.12
        self.tomatoes_vol_alpha = 0.05
        self.tomatoes_base_spread = 2.5
        self.tomatoes_take_size = 8
        self.tomatoes_quote_size = 12
